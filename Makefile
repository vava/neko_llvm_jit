...
LIBNEKO_OBJECTS = vm/alloc.o vm/builtins.o vm/callback.o vm/interp.o vm/load.o vm/objtable.o vm/others.o vm/hash.o vm/module.o vm/jit_x86.o vm/llvm_jit.o vm/llvm/jit.o vm/llvm/stack.o vm/threads.o
