...
LIBNEKO_OBJECTS = vm/alloc.o vm/builtins.o vm/callback.o vm/interp.o vm/load.o vm/objtable.o vm/others.o vm/hash.o vm/module.o vm/jit_x86.o vm/llvm_jit.o vm/llvm/jit.o vm/llvm/stack.o vm/llvm/module_code_base.o vm/llvm/function.o vm/llvm/neko_code_container.o vm/llvm/neko_code_chunk.o vm/llvm/basic_block.o vm/threads.o
