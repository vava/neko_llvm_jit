...
LIBNEKO_OBJECTS = vm/alloc.o vm/builtins.o vm/callback.o vm/interp.o vm/load.o vm/objtable.o vm/others.o vm/hash.o vm/module.o vm/jit_x86.o vm/llvm_jit.o vm/llvm/jit.o vm/llvm/stack.o vm/llvm/neko_module.o vm/llvm/neko_function.o vm/llvm/neko_code_container.o vm/llvm/neko_code_chunk.o vm/llvm/neko_basic_block.o vm/threads.o
